...
object Lap {
    def fromPacket(lapStream: Dataset[PacketLap], lobbyStream: Dataset[PacketLobbyInfo])(implicit spark: SparkSession): Dataset[Lap] = {
        ...
        allLapData
            ...
            .select(
                ...
                (col("lap_data.m_sector1_time_minutes_part") * 60000L + col("lap_data.m_sector1_time_ms_part")).as("sector1_time_ms"),
                (col("lap_data.m_sector2_time_minutes_part") * 60000L + col("lap_data.m_sector2_time_ms_part")).as("sector2_time_ms"),
